...
**Air Pollution** This is a SPA to pull data to check the levels of air pollution for different cities.
...
1. Clone this project on your local machine using the following command on your Git Bash: `https://github.com/TechnoAndy/air-pullution`

2. Browse to project directory `cd air-pullution`
...
- Creative Commons  for the design
- Microverse
- Google
- YouTube
- To the amazing people I have come across from day 1. The most supportive team ever.
